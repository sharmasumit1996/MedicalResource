 ...
 * @author sumit
 */
public class SysAdVitalsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form SysAdVitalsJPanel
     */
    PatientDirectory patientDirectory;
    EncounterHistory encounterHistory;
    DoctorDirectory doctorDirectory;
    Patient currPatient;
    public SysAdVitalsJPanel(PatientDirectory patientDirectory, EncounterHistory encounterHistory, DoctorDirectory doctorDirectory) {
        initComponents();
    ...
    private void UpdatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdatebtnActionPerformed
        ...
        if(Updatevalidate(EncounterNumbertxt.getText(),PatientIDtxt.getText(), Temperaturetxt.getText(), BloodPressuretxt.getText(), Pulsetxt.getText(),Doctortxt.getText())){
            ...
            vita.setEncounterNumber(Integer.parseInt(EncounterNumbertxt.getText()));
            vita.setPatientName(PatientIDtxt.getText());
            vita.setBloodPressure(Integer.parseInt(BloodPressuretxt.getText()));
            vita.setPulse(Integer.parseInt(Pulsetxt.getText()));
            vita.setTemperature(Integer.parseInt(Temperaturetxt.getText()));
            vita.setDoctorName(Doctortxt.getText());
            String EncounterNumber = EncounterNumbertxt.getText();
    ...
    private boolean validate(String EncounterNumber, String PatientID, String Temperature, String BP, String Pulse, String Doctor) {
        ...
        for(int i=0; i<patientDirectory.patHistory.size();i++){
            ...
            if(PatientID.equals(String.valueOf(pat.getPatientID()))){
                fetch = false;
                currPatient = pat;
                break;
            }
