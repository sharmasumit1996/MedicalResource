...
public class CommunityJPanel extends javax.swing.JPanel {
    ...
    public CommunityJPanel(CommunityHistory communityhistory, CityHistory cityhistory) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Communitylbl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Communitylbl.setText("Community");
        Communitylbl.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        CommJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Community ID", "Community Name", "City Name"
            }
        ));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(CommNamelbl, javax.swing.GroupLayout.PREFERRED_SIZE, 433, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(CommNametxt, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(CommunityIDtxt, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void DeleteCommbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteCommbtnActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) CommJTable.getModel();
        String CommID = model.getValueAt(selectedRowIndex, 0).toString();
        for(Community comm: communityhistory.getCommHistory()){
            if (CommID.equals(comm.getCommID())){
                System.out.println(CommID);
                System.out.println(comm.getCommID());
                communityhistory.deleteCommunity(comm);
                break;
            }
            }
            CommunityIDtxt.setText("");
            CommNametxt.setText("");
            CityNametxt.setText("");
            CommunityIDtxt.setEnabled(true);
    ...
    private void SavecommbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SavecommbtnActionPerformed
        ...
        if(validate(CommNametxt.getText(), CityNametxt.getText())){
            ...
            newCommunity.setCommID(CommunityIDtxt.getText());
    ...
    private void CommJTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CommJTableMouseClicked
        ...
        int selectedRowIndex = CommJTable.getSelectedRow();
        DefaultTableModel model = (DefaultTableModel) CommJTable.getModel();
        CommunityIDtxt.setText(model.getValueAt(selectedRowIndex, 0).toString());
        CommNametxt.setText(model.getValueAt(selectedRowIndex, 1).toString());
        CityNametxt.setText(model.getValueAt(selectedRowIndex, 2).toString());
        CommunityIDtxt.setEnabled(false);
    ...
    private void UpdateCommbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateCommbtnActionPerformed
        ...
        if(validate(CommNametxt.getText(),CityNametxt.getText())){
            ...
            String CommID = CommunityIDtxt.getText();
            String CommName = CommNametxt.getText();
        ...
        comm2.setCommID(CommID);
        comm2.setCommName(CommName);
        comm2.setCity(City);
