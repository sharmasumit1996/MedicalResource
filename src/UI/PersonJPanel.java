...
public class PersonJPanel extends javax.swing.JPanel {
    ...
    public PersonJPanel(PersonDirectory personDirectory, HouseHistory houseHistory, CityHistory cityHistory, CommunityHistory communityHistory) {
        initComponents();
    ...
    private void SavebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SavebtnActionPerformed
        ...
        if(validate(IDtxt.getText(),Nametxt.getText(), Integer.parseInt(Agetxt.getText()),ApartmentNotxt.getText(),Communitytxt.getText(), Citytxt.getText())){
            ...
            PersonNew.setPersonID(Integer.parseInt(IDtxt.getText()));
    ...
    private void UpdatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdatebtnActionPerformed
        ...
        if(Updatevalidate(IDtxt.getText(),Nametxt.getText(), Integer.parseInt(Agetxt.getText()),ApartmentNotxt.getText(),Communitytxt.getText(), Citytxt.getText())){
            ...
            String HouseNo = ApartmentNotxt.getText();
            String Community = Communitytxt.getText();
            String City = Citytxt.getText();
            for(Person pers: personDirectory.getPerHistory()){
            if (PersonID == pers.getPersonID()){
               personDirectory.deletePerson(pers);
                break;
            }
        }
        Person pers2 = personDirectory.addNewValue();
        pers2.setPersonID(PersonID);
        pers2.setName(Name);
        pers2.setAge(Age);
        pers2.setHouse(HouseNo);
        pers2.setCommunity(Community);
        pers2.setCity(City);
    ...
    private void DeletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeletebtnActionPerformed
        ...
        for(Person pers: personDirectory.getPerHistory()){
            if (Integer.parseInt(PersonID) == pers.getPersonID()){
                personDirectory.deletePerson(pers);
                break;
            }
            }
...
private boolean validate(String ID, String Name, int age, String houses, String community, String city){
        ...
        for(Person person: personDirectory.getPerHistory()){
            if(person.getPersonID()== Integer.parseInt(ID)){
                exists = true;
            }
        }
        if(ID.length() == 0){
...
private boolean Updatevalidate(String ID, String Name, int age, String houses, String community, String city){
        ...
        for(Person person: personDirectory.getPerHistory()){
            if(person.getPersonID()==Integer.parseInt(ID) && person.getName().equals(Name) && String.valueOf(person.getAge()).equals(age) && person.getHouse().equals(houses) && person.getCommunity().equals(community) && person.getCity().equals(city)){
                exists = true;
            }
        }
        if(ID.length() == 0){
